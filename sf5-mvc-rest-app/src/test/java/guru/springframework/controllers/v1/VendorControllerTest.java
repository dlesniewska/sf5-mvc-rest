...
public class VendorControllerTest extends AbstractRestControllerTest {
    ...
    public void setUp() throws Exception {
        vendorDTO_1 = new VendorDTO(ID_1, NAME_1, VendorController.getVendorUrl(ID_1));
        vendorDTO_2 = new VendorDTO(ID_2, NAME_2, VendorController.getVendorUrl(ID_2));
    }
    ...
    public void getVendorById() throws Exception {
        ...
        mockMvc.perform(get(VendorController.getVendorUrl(ID_1))
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void updateVendor() throws Exception {
        ...
        mockMvc.perform(put(VendorController.getVendorUrl(ID_1))
                .contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(vendorDTO_1)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.name", equalTo(vendorDTO_1.getName())));
    ...
    public void patchVendor() throws Exception {
        ...
        mockMvc.perform(patch(VendorController.getVendorUrl(ID_1))
                .contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(vendorDTO_1)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.name", equalTo(vendorDTO_1.getName())));
    ...
    public void deleteVendor() throws Exception {
        mockMvc.perform(delete(VendorController.getVendorUrl(ID_1)))
                .andExpect(status().isOk());
